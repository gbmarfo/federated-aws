...
class FedServer(object):
    ...
    def startup(self):
        ...
        # self.train_loader, self.test_loader, self.val_loader = self.evaluator.load_data_lstm()
    ...
    def evaluate_global_model(self):
        ...
        '''
        test_accuracy = self.evaluator.test_lstm_model(self.global_model, self.test_loader)
